...
# Use validation image where we have ground truth
img_path = "data/dataset/val_split/102699_sat.jpg"
...
cv2.imwrite("backend/outputs/val_prob_map.png", prob_img)

print("Saved val_prob_map.png")
